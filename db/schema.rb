...
ActiveRecord::Schema.define(version: 20150115075337) do
  ...
  create_table "orders", id: false, force: true do |t|
    ...
    t.decimal  "amount",                     precision: 16, scale: 3
    t.decimal  "shipmentfee",                precision: 16, scale: 3
    t.integer  "status",                                              default: 0
  ...
  add_index "user_goods_in_carts", ["live_show_id"], name: "index_user_goods_in_carts_on_live_show_id", using: :btree
  add_index "user_goods_in_carts", ["user_id"], name: "index_user_goods_in_carts_on_user_id", using: :btree
